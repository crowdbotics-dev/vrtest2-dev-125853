...
const Untitled4 = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      backgroundColor: '#f0f0f1'
          ...
          <View style={styles.row1}><CheckBox style={styles.kEEcwokJ} title="Checkbox Title"></CheckBox></View>
          <View style={styles.row2}><ImageBackground style={styles.ZtmPyWwj} source={{
          ...
          <View style={styles.row3}><Switch style={styles.uHPKayFv}></Switch></View>
      </ScrollView>
    </SafeAreaView>;
};
