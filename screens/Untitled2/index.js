...
const Untitled2 = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      backgroundColor: '#f0f0f1'
          ...
          <View style={styles.row1}><Slider style={styles.IgjPtxnQ} thumbStyle={{
          height: 20,
          width: 20
        }} thumbTintColor="#0000FF" maximumValue={1} minimumValue={0}></Slider><Switch style={styles.ibgnBfjB}></Switch><Text style={styles.xqUBOhrJ}>Lorem ipsum…</Text></View>
          <View style={styles.row2}><ImageBackground style={styles.NOZwjSSo} source={{
        ...
        }} resizeMode="cover"></ImageBackground><TextInput style={styles.GnpYscDN}></TextInput></View>
